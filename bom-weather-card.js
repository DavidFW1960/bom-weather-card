...
// #####
  ...
  get current() {
    ...
    var temperature = (parseFloat(Number(this._hass.states[this.config.entity_temperature].state).toFixed(places))).toLocaleString() ;
    ...
    var apparent = this.config.entity_apparent_temp ? (parseFloat(Number(this._hass.states[this.config.entity_apparent_temp].state).toFixed(places))).toLocaleString() : 0;
