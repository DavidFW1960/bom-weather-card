...
// Optional Entities
      ...
      try {root.getElementById("beaufort-text").textContent             = `Bft: ${this.beaufortWind} - ` } catch(e) {}
      ...
      try {root.getElementById("daily-summary-text").textContent        = `${this._hass.states[this.config.entity_daily_summary].state} ` + 
