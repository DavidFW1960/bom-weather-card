...
// Optional Entities
      ...
      if (this.config.entity_wind_bearing  && !this.config.alt_wind && this.config.entity_wind_speed_kt && this.config.entity_wind_gust_kt) { root.getElementById("wind-bearing-text-kt").textContent = `${this.current.windBearing} ` }
